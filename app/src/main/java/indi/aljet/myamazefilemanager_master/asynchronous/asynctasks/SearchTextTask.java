...
import indi.aljet.myamazefilemanager_master.activities.TextEditorActivity;
import indi.aljet.myamazefilemanager_master.utils.ImmutableEntry;
...
public class SearchTextTask extends AsyncTask
<Editable,Void,ArrayList<MapEntry>>{
