...
import indi.aljet.myamazefilemanager_master.utils.LruBitmapCache;
import indi.aljet.myamazefilemanager_master.utils.provider.UtilitiesProvider;
...
public class AppConfig extends GlideApplication {
    ...
    private static Handler mApplicationHandler = new
            Handler();
    private static HandlerThread sBackgroundHandlerThread = new
            HandlerThread("app_background");
    ...
    public void onCreate() {
        ...
        sBackgroundHandler = new Handler(sBackgroundHandlerThread
        .getLooper());
