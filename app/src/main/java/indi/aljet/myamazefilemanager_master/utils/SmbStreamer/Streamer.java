...
public class Streamer extends StreamServer {
    ...
    private static Pattern pattern = Pattern
            .compile("^.*\\.(?i)(mp3|wma|wav|aac|ogg|m4a|flac|mp4|avi|mpg|mpeg|3gp|3gpp|mkv|flv|rmvb)$");
    ...
    public Response serve(String uri, String method, Properties header, Properties parms, Properties files) {
        ...
        try{
            ...
            if(sourceFile == null){
                res = new Response(HTTP_NOTFOUND,
                        MIME_PLAINTEXT,null);
            }else{
                long startFrom = 0;
                long endAt = -1;
                ...
                final StreamSource source = new
                        StreamSource(sourceFile,length);
