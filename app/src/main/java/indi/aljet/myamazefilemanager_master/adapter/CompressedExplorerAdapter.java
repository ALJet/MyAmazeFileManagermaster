...
import indi.aljet.myamazefilemanager_master.adapter.holders.CompressedItemViewHolder;
...
public class CompressedExplorerAdapter extends
        RecyclerView.Adapter<CompressedItemViewHolder> {
